        ...
        >
          <div className="flex text-[#343434]">
            <div className="mx-20">
              ...
              <label htmlFor="quantity" className="block text-m font-bold mb-2">
                Category
              </label>
              <Select
                bordered={false}
              ...
              <div className="mt-4">
                <button
                  type="submit"
                  className="px-4 py-2 bg-purple text-xl text-white rounded hover:bg-purpler my-2"
            ...
            <div className="mx-5 mt-5">
              <div className="mt-10 ">
                <label
                  htmlFor="quantity"
                  className="block text-m font-bold mb-4"
                >
                  Upload Main Photo
                </label>
